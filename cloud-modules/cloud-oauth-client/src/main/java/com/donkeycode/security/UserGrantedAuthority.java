...
public final class UserGrantedAuthority implements GrantedAuthority {
    ...
    public UserGrantedAuthority(String authority, Date expireTime) {
        Assert.hasText(authority, "A granted authority textual representation is required");
        this.authority = authority;
        this.expireTime = expireTime;
    }

    public UserGrantedAuthority(String authorityId, String authority, Date expireTime, String owner) {
